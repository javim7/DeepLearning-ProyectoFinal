...
def preparar_datos(jornada, partido, tabla, dataModel):
    ...
    return homeTeamMapping, awayTeamMapping, PointsHome, PointsAway, GoalDiffHome, GoalDiffAway
...
if __name__ == "__main__":
    ...
    model = load_model('modelos/modelo4.h5')
    dataModel = pd.read_csv('modelos/data4.csv')
